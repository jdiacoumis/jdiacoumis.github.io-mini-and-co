...
Static marketing site for **Mini & Co**, a baby sensory class business (Oran Park, NSW). Plain HTML + CSS + a tiny JS file. No framework, no bundler, no package manifest. Deployed as static hosting (CNAME → `miniandcosensoryclasses.com`).
